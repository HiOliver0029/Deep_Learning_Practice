...
def get_memory_efficient_training_args(output_dir, num_train_epochs=3):
    """獲取記憶體高效的訓練參數"""
...
def load_and_prepare_data_efficient(train_file, tokenizer, max_length=256):
    """記憶體高效的數據載入"""
